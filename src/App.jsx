...
import illustrationThankYou from "./assets/feedback_imagens-main/illustration-thank-you.svg"
...
export function App() {
  ...
  return (
    submited === false ? (
      ...
      <button onClick={handleSubmit} className="bg-orange w-full py-3 rounded-3xl uppercase text-sm tracking-1 font-bold hover:bg-white hover:text-orange">submit</button>
    </div>
    ) : (
